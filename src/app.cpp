...
bool app_init(void* user_data) {
  ...
  ui_canvas_begin(s_app.canvas, glm::vec2(0.0f, 50.0f), UI_ANCHOR_CENTER);
  // ui_canvas_push_text(s_app.canvas, "SCORE: ", 30.0f, COLOR_WHITE);
  ui_canvas_push_button(s_app.canvas, "PLAY", 30.0f, COLOR_WHITE, COLOR_BLACK, nullptr, nullptr);
  ui_canvas_push_button(s_app.canvas, "SETTINGS", 30.0f, COLOR_WHITE, COLOR_BLACK, nullptr, nullptr);
  ui_canvas_push_button(s_app.canvas, "QUIT", 30.0f, COLOR_WHITE, COLOR_BLACK, nullptr, nullptr);
